...
class VueUser{
  ...
  public function showProfile($user, $nbPubli){
    ...
    echo "<div class=\"text-jaune-300 hover:text-jaune-600\">";
    echo "<a href=\"index.php?module=publication&action=ajouter\"><h1>Poster</h1></a>";
    echo "</div>";
    echo "</div>";
    echo "<div class=\"col-span-1 items-center justify-items-center\">";
    echo "<div class=\"\">";
    echo "<a href=\"index.php?module=connexion&action=deconnexion\" ><svg class=\"fill-current text-jaune-300\" xmlns=\"http://www.w3.org/2000/svg\" width=50 height=50 viewBox=\"0 0 20 20\"><path d=\"M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm1.41-1.41A8 8 0 1 0 15.66 4.34 8 8 0 0 0 4.34 15.66zm9.9-8.49L11.41 10l2.83 2.83-1.41 1.41L10 11.41l-2.83 2.83-1.41-1.41L8.59 10 5.76 7.17l1.41-1.41L10 8.59l2.83-2.83 1.41 1.41z\"/></svg></a>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
  }
